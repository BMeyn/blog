...
Dazu kommen strukturelle Probleme: Notebooks mit Outputs werden committed und blähen das Repository auf. Execution-Counter und Timestamps erzeugen unnötige Merge-Konflikte. Code-Reviews werden unleserlich, weil Output-Cells den eigentlichen Code-Diff verstecken.
...
Alternativ: Ruff ist ein modernes Tool, das Black und Flake8 kombiniert und deutlich schneller ist.
...
> Tipp: DevContainer können hier helfen, um den Entwicklern eine standarisierte Entwicklungsumgebung bereitzustellen ohne das jeder einzelnt tools installieren muss
{: .prompt-tip }
...
Auto-Formatting wie Black spart enorm Zeit. Keine Style-Diskussionen mehr in Code-Reviews. Teams berichten von 20-30 Prozent weniger Review-Kommentaren nach der Einführung.
...
Zu viele Checks überfordern das Team. Ein Projekt startete mit 15 verschiedenen Hooks - das Setup dauerte fünf Minuten pro Commit. Nach zwei Wochen nutzte die Hälfte des Teams `--no-verify`. Start simple: Black, Flake8, check-yaml. Weitere Checks kannst du später hinzufügen.
